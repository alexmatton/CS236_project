...
import torch
from models.transfo_semi_local import SemiLocalGenerativeTransformer
...
parser.add_argument("--kz", type=int, default=4, help="kernel size for local transformer")
parser.add_argument("--position_local_t", type=str, default="in_between", choices=["in_between", "local_before", "local_after"])
...
if __name__ == "__main__":
    ...
    generative_model = SemiLocalGenerativeTransformer(
        ...
        dropout=0.1,
        kz = opt.kz,
        position_local_t=opt.position_local_t
    )
